type DependContextSignature = ({ context, args }: {
    context: any;
    args: {
        property?: string;
        min?: number;
 ...
 * }
 */
export declare const dependContext: DependContextSignature;
type DependLooterSignature = ({ looter, args }: {
    looter: any;
    args: {
        property?: string;
        min?: number;
 ...
 * }
 */
export declare const dependLooter: DependLooterSignature;
export {};
